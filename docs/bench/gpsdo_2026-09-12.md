...
tests and this, the unit on USB changed: serial D65EE73B3D on a new device path (the
morning unit was G44009), reporting zero signal losses; either a second clock was
connected or the vendor program (GPSClockConfig 9.12, in Downloads) rewrote the unit.
Its plan is the vendor program's, not the morning plan: it (GPS reference f_in 97,600 Hz, N3 1, N2 10 × 6250, f_osc 6.100 GHz,
